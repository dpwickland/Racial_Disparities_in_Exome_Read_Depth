...
all_data <- subset(all_data, (race == 'Black' | race == 'White' | race == 'Asian'))
all_data <- subset(all_data, (Cancer == 'BRCA') | Cancer =='LUAD' | Cancer == 'COAD' | Cancer == 'PRAD' | Cancer == 'UCEC' | Cancer == 'KIRC' | Cancer == 'GBM' | Cancer == 'KIRP')
...
Medians$x <- rep(c(0.85,0.50,0.15),8)
Medians$y <- -11
...
ggplot(all_data_jittered, aes(x=jitter,y=log(nonsilent_per_Mb+.001,base=2),color=as.factor(race))) + facet_wrap(~Cancer,nrow=1,strip.position='bottom') + ylab("Nonsilent mutation rate") + 
  geom_point(aes(color=all_data_jittered$race)) +
  geom_boxplot(size=0.00005,fatten=40000,fill=NA,outlier.shape=NA,coef=0,color='black',aes(group=all_data_jittered$race)) + #outlier.shape=NA to remove points; size to remove plot; coef=0 to rm whiskers; size=0.00005 to make box almost invisible; fatten to make median visible
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=1.25, y=-12.45, label=subset(Ns,(Cancer=='COAD' & race=='White'))$N,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=1.60, y=-12.45, label=subset(Ns,(Cancer=='COAD' & race=='Black'))$N,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=2.4, y=-12.45, label=subset(Ns,(Cancer=='GBM' & race=='White'))$N,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=2.75, y=-12.45, label=subset(Ns,(Cancer=='GBM' & race=='Black'))$N,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=3.55, y=-12.45, label=subset(Ns,(Cancer=='KIRC' & race=='White'))$N,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=3.9, y=-12.45, label=subset(Ns,(Cancer=='KIRC' & race=='Black'))$N,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=4.7, y=-12.45, label=subset(Ns,(Cancer=='KIRP' & race=='White'))$N,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=5.05, y=-12.45, label=subset(Ns,(Cancer=='KIRP' & race=='Black'))$N,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=5.85, y=-12.45, label=subset(Ns,(Cancer=='LUAD' & race=='White'))$N,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=6.2, y=-12.45, label=subset(Ns,(Cancer=='LUAD' & race=='Black'))$N,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=7.0, y=-12.45, label=subset(Ns,(Cancer=='PRAD' & race=='White'))$N,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=7.35, y=-12.45, label=subset(Ns,(Cancer=='PRAD' & race=='Black'))$N,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=8.15, y=-12.45, label=subset(Ns,(Cancer=='UCEC' & race=='White'))$N,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=8.50, y=-12.45, label=subset(Ns,(Cancer=='UCEC' & race=='Black'))$N,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=1.25, y=-13.15, label=subset(Medians,(Cancer=='COAD' & race=='White'))$Median,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=1.60, y=-13.15, label=subset(Medians,(Cancer=='COAD' & race=='Black'))$Median,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=2.4, y=-13.15, label=subset(Medians,(Cancer=='GBM' & race=='White'))$Median,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=2.75, y=-13.15, label=subset(Medians,(Cancer=='GBM' & race=='Black'))$Median,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=3.55, y=-13.15, label=subset(Medians,(Cancer=='KIRC' & race=='White'))$Median,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=3.9, y=-13.15, label=subset(Medians,(Cancer=='KIRC' & race=='Black'))$Median,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=4.7, y=-13.15, label=subset(Medians,(Cancer=='KIRP' & race=='White'))$Median,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=5.10, y=-13.15, label=subset(Medians,(Cancer=='KIRP' & race=='Black'))$Median,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=5.85, y=-13.15, label=subset(Medians,(Cancer=='LUAD' & race=='White'))$Median,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=6.2, y=-13.15, label=subset(Medians,(Cancer=='LUAD' & race=='Black'))$Median,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=7.0, y=-13.15, label=subset(Medians,(Cancer=='PRAD' & race=='White'))$Median,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=7.35, y=-13.15, label=subset(Medians,(Cancer=='PRAD' & race=='Black'))$Median,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=8.15, y=-13.15, label=subset(Medians,(Cancer=='UCEC' & race=='White'))$Median,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=8.50, y=-13.15, label=subset(Medians,(Cancer=='UCEC' & race=='Black'))$Median,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=1.25, y=-13.85, label=subset(SDs,(Cancer=='COAD' & race=='White'))$SD,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=1.60, y=-13.85, label=subset(SDs,(Cancer=='COAD' & race=='Black'))$SD,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=2.4, y=-13.85, label=subset(SDs,(Cancer=='GBM' & race=='White'))$SD,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=2.75, y=-13.85, label=subset(SDs,(Cancer=='GBM' & race=='Black'))$SD,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=3.55, y=-13.85, label=subset(SDs,(Cancer=='KIRC' & race=='White'))$SD,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=3.9, y=-13.85, label=subset(SDs,(Cancer=='KIRC' & race=='Black'))$SD,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=4.7, y=-13.85, label=subset(SDs,(Cancer=='KIRP' & race=='White'))$SD,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=5.05, y=-13.85, label=subset(SDs,(Cancer=='KIRP' & race=='Black'))$SD,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=5.85, y=-13.85, label=subset(SDs,(Cancer=='LUAD' & race=='White'))$SD,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=6.2, y=-13.85, label=subset(SDs,(Cancer=='LUAD' & race=='Black'))$SD,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=7.0, y=-13.85, label=subset(SDs,(Cancer=='PRAD' & race=='White'))$SD,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=7.35, y=-13.85, label=subset(SDs,(Cancer=='PRAD' & race=='Black'))$SD,size=3.25,color='black',hjust=0.5)  + 
  ...
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=8.15, y=-13.85, label=subset(SDs,(Cancer=='UCEC' & race=='White'))$SD,size=3.25,color='black',hjust=0.5)  +
  geom_text(data=subset(all_data_jittered,(Cancer=='BRCA')),x=8.50, y=-13.85, label=subset(SDs,(Cancer=='UCEC' & race=='Black'))$SD,size=3.25,color='black',hjust=0.5)  + 
